    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php foreach ($jobExperience as $job => $values) { ?>
            <div class="w3-container">
              <h5 class="w3-opacity"><b><?php echo $job; ?></b></h5>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $values['start']; ?> - <span class="w3-tag w3-teal w3-round"><?php echo $values['end']; ?></span></h6>
